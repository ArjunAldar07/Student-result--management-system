...
public class StudentHome1 extends javax.swing.JFrame {
    ...
    public StudentHome1() {
        ...
        public StudentHome1(String rollmno) {
        initComponents();
        jTextField4.setText(rollmno);
    }
   @SuppressWarnings("unchecked")
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(jTextField11, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 76, Short.MAX_VALUE)
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
         ...
         String rollmno=jTextField4.getText();
        try
        {
             Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/studentresult","root","root");
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("select * from student inner join bcs1 where student.rollmno='"+rollmno+"' and bcs1.rollmno='"+rollmno+"'");
            if(rs.next())
            {
                ...
                int result1=result/7;
                String s=String.valueOf(result);
                String s11=String.valueOf(result1);
                jTextField14.setText(s);
                jTextField15.setText(s11);
                if(s1<0||s2<35||s3<35||s4<35||s5<35||s6<35||s7<35)
                {
